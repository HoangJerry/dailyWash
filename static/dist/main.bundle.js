...
// module
exports.push([module.i, ".nav .button-margin-top{\n\tmargin-top: 8px;\n\t/*vertical-align: middle;*/\n}", ""]);
...
var AppComponent = (function () {
    function AppComponent(_router, _api) {
        this._router = _router;
        this._api = _api;
        this.title = "Ngoc Hoang";
        this.errors = [];
        this.index();
    }
    ;
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* RouterModule */].forRoot(__WEBPACK_IMPORTED_MODULE_5__routing_module__["a" /* routes */], {}),
            ...
            __WEBPACK_IMPORTED_MODULE_10_ngx_bootstrap__["c" /* CollapseModule */].forRoot(),
        ],
        providers: [
...
var AppService = (function () {
    ...
    AppService.prototype.Index = function () {
        var url = this.apiUrl + '/';
    ...
    AppService.prototype.UserList = function () {
    ...
    AppService.prototype.UserDelete = function (id) {
        var url = this.apiUrl + '/user/' + id + '/';
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__user_detail_user_detail_component__ = __webpack_require__("../../../../../src/app/user-detail/user-detail.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user_list_user_list_component__ = __webpack_require__("../../../../../src/app/user-list/user-list.component.ts");
...
var routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'detail/:id',
                component: __WEBPACK_IMPORTED_MODULE_0__user_detail_user_detail_component__["a" /* UserDetailComponent */]
            },
        ]
    },
    {
...
var SideBarComponent = (function () {
    ...
    SideBarComponent.prototype.collapsed = function (event) {
        console.log(event);
    };
    SideBarComponent.prototype.expanded = function (event) {
        console.log(event);
    };
...
var UserDetailComponent = (function () {
    function UserDetailComponent(_router, _api, route) {
        var _this = this;
        this._router = _router;
        this._api = _api;
        this.route = route;
...
module.exports = "\n<p>\n  user-list works!\n</p>\n<ul>\n  <li *ngFor=\"let user of users\">\n  <!-- <li *ngFor=\"let user of users\" [routerLink]=\"['/admin/dashboard/detail']\"> -->\n    <span class=\"red\">{{user.id}}</span>\n    <span routerLink=\"/dashboard/detail/{{user.id}}\">{{user.email}}</span>\n    <a href=\"\" (click) = \"delUser($event,user.id);\">x</a>\n  </li>\n</ul>\n<!-- <app-user-detail [id]=\"selectedId\"></app-user-detail> -->\n<router-outlet></router-outlet>"
...
var UserListComponent = (function () {
    function UserListComponent(_router, _api) {
        this._router = _router;
        this._api = _api;
        this.users = [];
        this.errors = [];
    ...
    ;
    UserListComponent.prototype.delUser = function (event, id) {
        var _this = this;
